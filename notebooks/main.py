...
class FraudDetectionPipeline:
    ...
    def preprocess_data(self):
        ...
        try:
            ...
            # Save processed data
            processed_data_path = os.path.join('data', 'processed_fraud_data.csv')
    ...
    def train_and_evaluate(self):
        ...
        try:
            ...
            # Save both models
            lr_path = os.path.join('src', 'logistic_regression_model.pkl')
            rf_path = os.path.join('src', 'random_forest_model.pkl')
            ...
            best_model_path = os.path.join('src', 'best_fraud_model.pkl')
